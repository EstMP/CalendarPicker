namespace MyFactory {
    ...
    export function createElement(tagName: string, attributes: JSX.IntrinsicElements | null, ...children: any[]): Element | DocumentFragment {
        if (tagName === Fragment) {
        ...
        if (attributes) {
            for (const key of Object.keys(attributes)) {
                ...
                if (key === "className") { // JSX does not allow class as a valid name
                    ...
                    element.addEventListener('click', attributeValue);
                } else {
